...
### HTTP.get(String, list: headers -> Optional, Number: timeout -> Optional) -> Result
...
### HTTP.post(String, dictionary: postArgs -> Optional, list: headers -> Optional, Number: timeout -> Optional) -> Result
...
### httpClient.post(String, Dict: postArgs) -> Result
